...
public class Main {
    public static void main(String[] args) {
        ...
        // Тестирование работы менеджера файлов
        TaskManager fileBackedTaskManager = Managers.getDefaultFileBackedTaskManager();

        SingleTask singleTask1File = new SingleTask("CommonTask1", "Common task 1");
        fileBackedTaskManager.createTask(singleTask1File);

        SingleTask singleTask2File = new SingleTask("CommonTask2", "Common task 2");
        fileBackedTaskManager.createTask(singleTask2File);

        EpicTask epicTask1File = new EpicTask("EpicTask1", "Epic task 1");
        fileBackedTaskManager.createTask(epicTask1File);

        SubTask subTask1File = new SubTask("SubTask1", "Subtask 1", epicTask1File.getId());
        fileBackedTaskManager.createTask(subTask1File);
        SubTask subTask2File = new SubTask("SubTask2", "Subtask 2", epicTask1File.getId());
        fileBackedTaskManager.createTask(subTask2File);

        EpicTask epicTask2File = new EpicTask("EpicTask2", "Epic task 2");
        fileBackedTaskManager.createTask(epicTask2File);

        SubTask subTask3File = new SubTask("SubTask3", "Subtask 3", epicTask2File.getId());
        fileBackedTaskManager.createTask(subTask3File);
        ...
        // Тестирование работы обычного менеджера задач
